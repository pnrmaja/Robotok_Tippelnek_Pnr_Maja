...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void generalas() {
        ...
        tipp1 = (int)(Math.random() * db) + also;
        tipp2 = (int)(Math.random() * db) + also;
        tipp3 = (int)(Math.random() * db) + also;
        
        String haromRobotTippSzoveg = "";
        String egyRobotTippekSzoveg = "";
        if (jCheckBox2.isSelected()) {
            haromRobotTippSzoveg = jTextArea1.getText();
            egyRobotTippekSzoveg = jTextArea2.getText();
        }
        ...
        if (!jRadioButton2.isSelected()) {
            haromRobotTippSzoveg += "A kitalálandó szám: " + szam1 + "\n";
        }
        
        if (!jRadioButton1.isSelected()) {
            haromRobotTippSzoveg += "1. robot tippje: " + tipp1 + "\n";
            haromRobotTippSzoveg += "2. robot tippje: " + tipp2 + "\n";
            haromRobotTippSzoveg += "3. robot tippje: " + tipp3 + "\n";
        }
        ...
        if(tipp1 == szam1){
            voltTalalat = true;
            haromRobotTippSzoveg += "Az 1. robot eltalálta!\n";
        }
        if(tipp2 == szam1){
            voltTalalat = true;
            haromRobotTippSzoveg += "A 2. robot eltalálta!\n";
        }
        if(tipp3 == szam1){
            voltTalalat = true;
            haromRobotTippSzoveg += "A 3. robot eltalálta!\n";
        }
        if(!voltTalalat){
            haromRobotTippSzoveg += "Egyik robot sem találta el!\n";
        }
        
        /* az 1. tipp beállítása: */
        int szam2 = (int)(Math.random() * db) + also;
        int tipp = (int)(Math.random() * db) + also;
        

        /* tippelések kiírása és vizsgálata: */
        if (!jRadioButton2.isSelected()) {
            egyRobotTippekSzoveg += "A kitalálandó szám: " + szam2 +"\n";
        }

        if (!jRadioButton1.isSelected()) {
            egyRobotTippekSzoveg += "A 1. tipp: " + tipp +"\n";
        }
        
        if(tipp == szam2){
            egyRobotTippekSzoveg +="Elsőre sikerült eltalálni!\n";
        }else{
            tipp = (int)(Math.random() * db) + also;
            if (!jRadioButton1.isSelected()) {
                egyRobotTippekSzoveg += "A 2. tipp: " + tipp +"\n";
            }
            if(tipp == szam2){
                egyRobotTippekSzoveg +="Másodikra sikerült eltalálni!\n" ;
            }else{
                tipp = (int)(Math.random() * db) + also;
                if (!jRadioButton1.isSelected()) {
                    egyRobotTippekSzoveg += "A 3. tipp: " + tipp +"\n";
                }
                if(tipp == szam2){
                    egyRobotTippekSzoveg +="Harmadikra sikerült eltalálni!\n";
                }else{
                    egyRobotTippekSzoveg += "Nem sikerült háromból eltalálni!\n";
                }
            }
        }
        
        jTextArea1.setText(haromRobotTippSzoveg + "\n");
        jTextArea2.setText(egyRobotTippekSzoveg + "\n");
    }
